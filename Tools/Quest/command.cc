...
#include "glob.h"
#include "gen.h"
#include <cstring> //added by MJZaki for strcmp
#include <iostream>
...
void command_line(TaxPar &par)
{
    ...
    cerr << "  -ntrans number_of_transactions (in 1000's) (default: " << par.ntrans / 1000
        << ")\n";
    ...
    cerr << "  -depth affects_average_depth_of_items_in_itemsets (default: " << par.depth_ratio
        << ")\n";
    cerr << endl;

    cerr << "  -npats number_of_patterns (default: " << par.lits.npats << ")\n";
    cerr << "  -patlen avg_length_of_maximal_pattern (default: " << par.lits.patlen << ")\n";
...
{
    cerr << "Command Line Options:\n";
    cerr << "  -ncust number_of_customers (in 1000's) (default: " << par.ncust / 1000 << ")\n";
    ...
    cerr << "  -seq.patlen avg_length_of_maximal_pattern (default: " << par.lseq.patlen
        << ")\n";
    cerr << "  -seq.corr correlation_between_patterns (default: " << par.lseq.corr << ")\n";
    cerr << "  -seq.conf avg_confidence_in_a_rule (default: " << par.lseq.conf << ")\n";
    cerr << endl;

    cerr << "  -lit.npats number_of_patterns (default: " << par.lits.npats << ")\n";
    cerr << "  -lit.patlen avg_length_of_maximal_pattern (default: " << par.lits.patlen
        << ")\n";
    cerr << "  -lit.corr correlation_between_patterns (default: " << par.lits.corr << ")\n";
...
void get_args(SeqPar &par, int argc, char **argv)
{
    ...
    while (arg_pos < argc) {
        if (strcmp(argv[arg_pos], "-ncust") == 0) {
            ...
            ++arg_pos;
            cout << "INCR :" << par.CustRatio << " " << par.TransRatio << " " << par.IncrTid
                << endl;
            continue;
        } else if (strcmp(argv[arg_pos], "-ascii") == 0) {
            par.ascii = TRUE;
